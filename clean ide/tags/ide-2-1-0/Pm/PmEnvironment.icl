...
t_StdEnv20 =
	...
	, target_objs	= Nil
	, target_stat	= Nil
	, target_comp	= "Tools\\Clean System 2.1.0\\CleanCompiler210.exe"
	, target_cgen	= "Tools\\Clean System 2.1.0\\CodeGenerator210.exe"
	, target_link	= "Tools\\Clean System 2.1.0\\StaticLinker13.exe"
	, target_dynl	= "Tools\\Dynamics 0.3\\DynamicLinker13.exe"
	, target_vers	= 919
	, target_redc	= False
...
t_StdIO20 =
	...
	, target_path	=
		(	"{Application}\\Libraries\\StdEnv 2.1"
		:!	"{Application}\\Libraries\\StdLib 2.1"
		:!	"{Application}\\Libraries\\ObjectIO ObjectIO 1.2.3"
		:!	"{Application}\\Libraries\\ObjectIO ObjectIO 1.2.3\\OS Windows"
		:!	Nil
		)
	}
