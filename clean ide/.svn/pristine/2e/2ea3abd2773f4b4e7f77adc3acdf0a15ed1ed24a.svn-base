...
link_xcoff_files file_names library_file_names application_file_name font_info heap_size heap_size_multiple stack_size
				flags extra_application_memory initial_heap_size memory_profile_minimum_heap_size generate_xcoff files
	# one_pass_link = True;
...
/* ... RWS */
	...
	# (ok2,files6) = create_application_resource application_file_name /* RWS ... */ application_existed /* ... RWS */ font_info heap_size heap_size_multiple stack_size flags
